...
export default function ExplorePage() {
  return (
    <>
      ...
      <section className="product-section explore-readings">
        <div className="section-row">
          <div>
            <p className="eyebrow">KEEP EXPLORING</p>
            <h2>Find your next reading</h2>
          </div>
      ...
      <section className="depth-ladder">
        <p className="eyebrow">GO DEEPER</p>
        <h2>One idea. More context.</h2>
        <p className="depth-description">
          Start with a short reading, then follow the thread toward context and the source.
        </p>
        <div className="depth-steps">
          {['30 sec · Discover', '2 min · Understand', '5 min · Explore', 'Source · Read deeper'].map(
            (step, index) => (
              <span key={step}>
