  ...
  return (
    <main className="info-page">
      <header className="app-header route-header">
        <Link className="brand-lockup" href="/" aria-label="Yadesh home"><span className="brand-mark" aria-hidden="true"><Flame /></span><span className="brand-wordmark">YADESH</span><span className="brand-subtitle">Live record</span></Link>
        <nav className="desktop-nav" aria-label="Primary navigation"><Link href="/archive" className="nav-topics">Topics <span aria-hidden="true">⌄</span></Link><Link href="/archive" className="nav-cta">Enter the feed</Link><Link href="/about" className="nav-login">About</Link><button className="nav-menu" type="button" aria-label="Open menu"><Menu aria-hidden="true" /></button></nav>
      </header>
